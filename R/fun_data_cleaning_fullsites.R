...
#' @export
#'
fun_data_cleaning_fullsites <- function(raw_data){
  ...
  data_filtered <- data[grepl("RUNARMS1|RUNARMS2|RUNARMS3|RUNARMS4|RUNARMS5|RUNARMS6|RUNARMS7|RUNARMS8|RUNARMS9|P50|RODRARMS", meta_data$Image.name),]
  meta_filtered <- meta_data[grepl("RUNARMS1|RUNARMS2|RUNARMS3|RUNARMS4|RUNARMS5|RUNARMS6|RUNARMS7|RUNARMS8|RUNARMS9|P50|RODRARMS", meta_data$Image.name),]
  ...
  name_metadata <- "metadata_clean_fullsites.csv"
  ...
  name_data_mean <- "data_mean_clean_fullsites.csv" 
  name_metadata_mean <- "metadata_mean_clean_fullsites.csv"
  ...
  name_data_mean <- "data_pool_clean_fullsites.csv" 
  ...
  name_data_mean_pool <- "data_mean_pool_clean_fullsites.csv" 
